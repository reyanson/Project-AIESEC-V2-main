    ...
    <ListItem alignItems="flex-start">
        ...
        secondary={
            ...
            <Typography sx={{mt:'30px',ml:'-100px'}}>
                llllllllllllllllllllllllllllllllllllllllLists are a continuous group of text or images. They are composed of items containing primary and supplemental actions, which are represented by icons and text.
                llllllllllllllllllllllllllllllllllllllllLists are a continuous group of text or images. They are composed of items containing primary and supplemental actions, which are represented by icons and text
                </Typography> 
  ...
  <Grid item xs={10.7}>
    ...
    <ListItem alignItems="flex-start">
        ...
        <Typography sx={{ display: 'inline' }} maxWidth={'100%'} variant='container'>
                ...
                llllllllllllllllllllllll llllllllllllllllLists are a continuous group of text or images. They are composed of items containing primary and supplemental actions, which are represented by icons and text
                </Typography>
        </React.Fragment>
