...
export default function ViewUser() {
  ...
  return (
    ...
    <Topbar/>
    <Sidebar/>    
    <div className='container mw-80  mt-5'>
...
<Grid container spacing={2} >
  <Grid item xs={12} >
    <Box >
    <div className=' border  rounded mt-3    shadow mt-5' >
  ...
  <Grid item xs={10.7}>
    ...
    <div className='  border  rounded    shadow' style={{maxHeight:'550px',minHeight:'120px',height:'400px'}} >
